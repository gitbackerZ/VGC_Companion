        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: const [
              ...
              SizedBox(height: 8),
              Text('Nickname Clause', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
              Text('A nickname can\'t match another real Pokémon\'s name, to avoid confusion.', style: TextStyle(fontSize: 11)),
              SizedBox(height: 8),
              Text('Sleep Clause', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
              Text('A player may not have more than one opposing Pokémon asleep from their own moves at a time.', style: TextStyle(fontSize: 11)),
              SizedBox(height: 8),
              Text('OHKO Clause', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
              Text('One-hit-KO moves (Fissure, Horn Drill, Sheer Cold, Guillotine) are banned.', style: TextStyle(fontSize: 11)),
              SizedBox(height: 8),
              Text('Evasion Clause', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
              Text('Moves and items that boost evasion (e.g. Double Team, Bright Powder) are banned.', style: TextStyle(fontSize: 11)),
              SizedBox(height: 8),
              Text('Team Preview', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
              Text('Both teams are revealed before battle begins, before selecting a lineup.', style: TextStyle(fontSize: 11)),
              SizedBox(height: 8),
              ...
              SizedBox(height: 8),
              Text('Bring 4 (Toggle)', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
